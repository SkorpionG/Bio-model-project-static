...
import { primitiveEarth, presentEarth, photosynthesis, cellularRespiration, carbonCycle } from './description.js';

const {presentEarthModel,
       primitiveEarthModel,
       photosynthesisModel,
       cellularRespModel,
       carbonCycleModel
...
const primitiveDescription = generateDescription("Primitive Earth",
                                                primitiveEarth.title,
                                                primitiveEarth.description);

const presentDescription = generateDescription("Present Earth",
                                                presentEarth.title,
                                                presentEarth.description);

const photosynthesisDescription = generateDescription("Photosynthesis",
                                                photosynthesis.title,
                                                photosynthesis.description);

const cellularRespDescription = generateDescription("Cellular Respiration",
                                                cellularRespiration.title,
                                                cellularRespiration.description);

const carbonCycleDescription = generateDescription("Carbon Cycle",
                                                carbonCycle.title,
