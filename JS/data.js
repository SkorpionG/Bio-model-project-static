...
export const models = {
    ...
    photosynthesisModel: `<img id="cellularResp-model" src="assets/Photosynthesis.drawio.png">`,
    cellularRespModel: `<img id="photosynthesis-model" src="assets/CellularRespiration.drawio.png">`,
    carbonCycleModel: `<img id="carbonCycle-model" src="assets/CarbonCycle.drawio.png">`
}