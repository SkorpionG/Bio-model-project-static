export const primitiveEarth = {
  ...
  description: [
    "The atmosphere of primitive earth is not suitable for living things. It is composed mainly of water vapor and Carbon dioxide and contains 0% oxygen.",
...
export const presentEarth = {
  title: [
    "Atmosphere of the Present Earth",
    "Atmospheric Composition Percentage",
  ],
  description: [
    "Over billions of years, organisms that can do photosynthesis have converted much of the Carbon dioxide in the atmosphere into oxygen. It lowers the atmospheric CO<sub>2</sub> percentage from the initial 12% down to 0.04% today and increases the oxygen level from 0% to 21%.",
    "Because there's only 0.04% carbon dioxide in the atmosphere, the graph couldn't show the portion of carbon dioxide.",
  ],
};

export const photosynthesis = {
  title: [
    "Role of Photosynthesis in the Atmosphere",
    "Chemical Formula of Photosynthesis",
  ],
  description: [
    "Plants, algae, and some bacteria do photosynthesis. Photosynthesis uses sunlight to split water into oxygen that gets released into the atmosphere and absorbs carbon dioxide from the atmosphere to transform it into glucose. As a result, oxygen stocks up in the atmosphere, lowering the CO<sub>2</sub> level and making the atmosphere much more suitable for living. The product of photosynthesis feeds heterotrophs.",
...
export const cellularRespiration = {
  title: [
    "Role of Cellular Respiration in the Atmosphere",
    "Chemical Formula of Cellular Respiration",
  ],
  description: [
    "Plants and animals do cellular respiration, which uses oxygen and glucose to generate energy and release water and carbon dioxide into the atmosphere. Cellular respiration adds CO<sub>2</sub> into the atmosphere and is part of the carbon cycle. The product of cellular respiration feeds to autotrophs.",
